...
export class ObrazovanjeComponent implements OnInit, OnDestroy {
  ...
  public openDialog(flag: number, id?: number, naziv?: string, stepen_strucne_spreme?: string, opis?: string): void {
    const dialogRef = this.dialog.open(ObrazovanjeDialogComponent, {data: {id,naziv,stepen_strucne_spreme,opis}});
