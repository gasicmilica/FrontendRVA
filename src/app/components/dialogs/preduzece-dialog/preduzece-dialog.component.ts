...
export class PreduzeceDialogComponent implements OnInit {
  ...
  public add() : void {
    ...
    (error:Error) => {
      ...
      this.snackBar.open('Došlo je do greške prilikom dodavanja novog preduzeca.', 'Zatvori', {
        duration: 2500
      })
  ...
  public update(): void {
    ...
    (error:Error) => {
      console.log(error.name + ' ' + error.message);
      this.snackBar.open('Došlo je do greške prilikom izmene preduzeca.', 'Zatvori', {
        duration: 2500
      })
  ...
  public delete(): void {
    ...
    (error:Error) => {
      console.log(error.name + ' ' + error.message);
      this.snackBar.open('Došlo je do greške prilikom brisanja preduzeca.', 'Zatvori', {
        duration: 2500
      })
